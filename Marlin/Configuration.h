...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define PID_BED_INTEGRAL_DRIVE_MAX MAX_BED_POWER //limit for the integral term
	...
	#define  DEFAULT_bedKp 200.95
	#define  DEFAULT_bedKi 15.97
	#define  DEFAULT_bedKd 632.14
...
#define DEFAULT_ACCELERATION          3600    // X, Y, Z and E acceleration in mm/s^2 for printing moves
#define DEFAULT_RETRACT_ACCELERATION  3600    // E acceleration in mm/s^2 for retracts
#define DEFAULT_TRAVEL_ACCELERATION   3600    // X, Y, Z acceleration in mm/s^2 for travel (non printing) moves
